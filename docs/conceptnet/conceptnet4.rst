...
The :mod:`conceptnet` module
=============================

The :mod:`conceptnet` module contains the :class:`Concept`,
...
.. image:: _static/graph/conceptnet4.png
   :width: 600
   :alt: Model diagram for the conceptnet module
...
.. autoclass:: RawAssertion
    :members: nl_repr, set_rating, make, surface
